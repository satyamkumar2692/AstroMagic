...
//           ></img>
//         </div>
//         <div className="lg:mt-6 mt-3 bg-purple-950 bg-opacity-65 shadow-sm  shadow-purple-800 rounded-xl lg:rounded-3xl py-4 lg:py-8 px-4 lg:px-8 w-full">
//           <div className="flex flex-col lg:flex-row justify-evenly py-2 w-12/12 items-start">
